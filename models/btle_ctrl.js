...
var query = client.query('CREATE TABLE profiles(profile_name VARCHAR(25) PRIMARY KEY, turn_on BOOLEAN, colour TEXT, hour INT, minute INT, recur_weekly BOOLEAN, recur_daily BOOLEAN, active BOOLEAN)');
